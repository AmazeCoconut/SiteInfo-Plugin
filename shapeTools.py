...
class ShapeTools(object):
    ...
    def initGui(self):
        ...
        icon = QIcon(self.plugin_dir + '/images/AISicon.png')
        self.createArcAction = menu.addAction(icon, tr('Create arc wedge Tao'), self.createArc)
        self.createArcAction.setObjectName('stCreateArcWedge')

        icon = QIcon(self.plugin_dir + '/images/donut.png')
        self.createDonutAction = menu.addAction(icon, tr('Create donut Tao'), self.createDonut)
        self.createDonutAction.setObjectName('stCreateDonut')

        icon = QIcon(self.plugin_dir + '/images/ellipse.png')
        self.createEllipseAction = menu.addAction(icon, tr('Create ellipse Tao'), self.createEllipse)
